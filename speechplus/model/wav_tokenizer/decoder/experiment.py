...
class VocosExp(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx, **kwargs):
        ...
        if optimizer_idx == 1:
            ...
            loss = (
                loss_gen_mp + self.hparams.mrd_loss_coeff * loss_gen_mrd + loss_fm_mp +
                self.hparams.mrd_loss_coeff * loss_fm_mrd + self.mel_loss_coeff * mel_loss +
                1000 * commit_loss + loss_dac_1 + loss_dac_2)
