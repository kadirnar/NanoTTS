...
def generate_speech_from_text(
    ...
    prompt = [
        {'role': 'user', 'content': f'Convert the text to speech:{text_with_markers}'},
    ...
    try:
        ...
        print("Generated sequence:", tokenizer.decode(generated_ids, skip_special_tokens=False))
        return None
...
if __name__ == "__main__":
    ...
    # Common parameters
    parser.add_argument("--model_path", type=str, help="Path to the fine-tuned model", default="output/checkpoint-1000")
    parser.add_argument("--tokenizer_path", type=str, help="Path to the tokenizer (defaults to model_path)", default="output/checkpoint-1000")
    parser.add_argument("--wav_tokenizer_model", type=str, default="wavtokenizer_large_speech_320_v2.ckpt", 
                        help="Path to the WavTokenizer model checkpoint")
    parser.add_argument("--wav_tokenizer_config", type=str, 
    ...
    tts_parser.add_argument("--output_path", type=str, default="generated_speech.wav", help="Path to save generated audio")
